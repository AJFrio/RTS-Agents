...
module.exports = {
  ...
  addGeminiPath: (path) => ipcRenderer.invoke('settings:add-gemini-path', { path }),
  removeGeminiPath: (path) => ipcRenderer.invoke('settings:remove-gemini-path', { path }),
  getGeminiPaths: () => ipcRenderer.invoke('settings:get-gemini-paths'),
