...
Add `*-llms.txt` files here when you vendor stable third-party CLI/API summaries (e.g. wrangler flags). Keep files focused; regenerate when upstream changes materially.
