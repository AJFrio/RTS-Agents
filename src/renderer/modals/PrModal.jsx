      ...
      <div className="bg-sidebar-dark border border-border-dark w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span
                ...
                className={`px-2 py-0.5 text-[10px] technical-font font-bold ${
                  state === 'open' ? 'bg-emerald-500/20 text-emerald-500' : 'bg-slate-700 text-slate-300'
                }`}
              >
                {state.toUpperCase()}
              </span>
            </div>
            <h2 id="pr-modal-title" className="text-xl font-display font-bold text-white tracking-tight leading-tight">
              {data?.title || 'Loading...'}
            </h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-background-dark">
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-[#1A1A1A] border border-border-dark p-4">
            ...
            <div className="bg-[#1A1A1A] border border-border-dark p-4">
              ...
              <div id="pr-modal-base" className="text-xs font-mono text-slate-300">{data?.base?.ref ?? '—'}</div>
            </div>
          </div>
          <div className="mb-8">
            ...
            <div
              id="pr-modal-body"
              className="prose prose-invert prose-sm max-w-none text-slate-300 font-light leading-relaxed"
